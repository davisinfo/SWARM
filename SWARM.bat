...
powershell -executionpolicy Bypass -command ".\startup.ps1 -RigName1 SERVER04 -Currency USD -CoinExchange BTC -Location EUROPE -PoolName hashrefinery,starpool,fairpool,nicehash,nlpool,phiphipool,zpool,ahashpool,whalesburg,zergpool -Type AMD1 -Wallet1 1MGwuGQrAVLa8XCMAXJ6FcUJ1kmWvYMtxT -Donate .5 -WattOMeter No -platform windows -Farm_Hash 4a48607a4b24d7ab8fc0bca12a184bd1f2631854 -SWARM_Mode Yes -ETH 0x5146cda01a47B0168311DA2c56A3aB5d941BF8C5 -Worker SERVER04 -Nicehash_Wallet1 3CJFwLJVg7ZREAmD1kNPZypCx4PDUZuvGh -Switch_Threshold 3 -Stat_Algo Minute_10 -StatsInterval 1000"